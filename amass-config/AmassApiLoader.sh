...
# scans through all environment variables. For each variable, if its name is found in config.ini, the script
...
ORIGINAL_CONFIG_FILE="/root/osmedeus-base/data/amass-config/config.ini"
NEW_CONFIG_FILE="/root/osmedeus-base/data/amass-config/config-api.ini"
